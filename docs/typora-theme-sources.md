...
| `dkheng/DogsChoice` | `dogschoice-pink` / `狗狗粉（DogsChoice）` | `dogs-qicaihong.css` (pink only; `dogs-jidilan.css` and `dogs-yuanshanlv.css` intentionally excluded) | `狗狗粉-dogs-choice.css` |
