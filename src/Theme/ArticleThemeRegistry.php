...
final class ArticleThemeRegistry {
	...
	public function all() {
		$themes = array(
			...
			'phycat-cherry'   => $this->theme( 'phycat-cherry', __( '樱桃猫', 'easymde' ), 'assets/themes/article/phycat-cherry.css', 'phycat-cherry-code', true, '#aa1111' ),
			'phycat-caramel'  => $this->theme( 'phycat-caramel', __( '焦糖猫', 'easymde' ), 'assets/themes/article/phycat-caramel.css', 'phycat-caramel-code', true, '#f59e0b' ),
			'phycat-forest'   => $this->theme( 'phycat-forest', __( '森林猫', 'easymde' ), 'assets/themes/article/phycat-forest.css', 'phycat-forest-code', true, '#11aa63' ),
			'phycat-mint'     => $this->theme( 'phycat-mint', __( '薄荷猫', 'easymde' ), 'assets/themes/article/phycat-mint.css', 'phycat-mint-code', true, '#3db8bf' ),
			'phycat-sky'      => $this->theme( 'phycat-sky', __( '天蓝猫', 'easymde' ), 'assets/themes/article/phycat-sky.css', 'phycat-sky-code', true, '#3498db' ),
			'phycat-prussian' => $this->theme( 'phycat-prussian', __( '普鲁士猫', 'easymde' ), 'assets/themes/article/phycat-prussian.css', 'phycat-prussian-code', true, '#1d4e89' ),
			'phycat-sakura'   => $this->theme( 'phycat-sakura', __( '樱花猫', 'easymde' ), 'assets/themes/article/phycat-sakura.css', 'phycat-sakura-code', true, '#ff7096' ),
			'phycat-mauve'    => $this->theme( 'phycat-mauve', __( '淡紫猫', 'easymde' ), 'assets/themes/article/phycat-mauve.css', 'phycat-mauve-code', true, '#a06eb4' ),
