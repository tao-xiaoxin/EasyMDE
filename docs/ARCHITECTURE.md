...
- `frontend/`: strict TypeScript, React, CodeMirror, and Vite source for the production normal-editor Toolbar and document session, plus the test-only WordPress React build-contract fixture.
