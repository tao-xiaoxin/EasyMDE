...
final class SettingsCenterStrings {
	...
	public static function get() {
		return array(
			...
			'uploadDestination'                            => __( 'Upload Destination', 'easymde' ),
			'wordpressMediaLibrary'                        => __( 'WordPress Media Library', 'easymde' ),
			'remoteImageHost'                              => __( 'Remote Image Host', 'easymde' ),
			...
			'r2AccountId'                                  => __( 'Cloudflare Account ID', 'easymde' ),
