...
final class ArticleThemeRegistry {
	...
	public function all() {
		$themes = array(
			...
			'inkwell'         => $this->theme( 'inkwell', __( '墨砚', 'easymde' ), 'assets/themes/article/inkwell.css', 'atom-one-dark', true, '#3b82c4' ),
			'animal-island'   => $this->theme( 'animal-island', __( '动物岛', 'easymde' ), 'assets/themes/article/animal-island.css', 'atom-one-dark', true, '#19c8b9' ),
			'phycat-cherry'   => $this->theme( 'phycat-cherry', __( '樱桃猫', 'easymde' ), 'assets/themes/article/phycat-cherry.css', 'atom-one-dark', true, '#aa1111' ),
			'phycat-caramel'  => $this->theme( 'phycat-caramel', __( '焦糖猫', 'easymde' ), 'assets/themes/article/phycat-caramel.css', 'atom-one-dark', true, '#f59e0b' ),
			'phycat-forest'   => $this->theme( 'phycat-forest', __( '森林猫', 'easymde' ), 'assets/themes/article/phycat-forest.css', 'atom-one-dark', true, '#11aa63' ),
			'phycat-mint'     => $this->theme( 'phycat-mint', __( '薄荷猫', 'easymde' ), 'assets/themes/article/phycat-mint.css', 'atom-one-dark', true, '#3db8bf' ),
			'phycat-sky'      => $this->theme( 'phycat-sky', __( '天蓝猫', 'easymde' ), 'assets/themes/article/phycat-sky.css', 'atom-one-dark', true, '#3498db' ),
			'phycat-prussian' => $this->theme( 'phycat-prussian', __( '普鲁士猫', 'easymde' ), 'assets/themes/article/phycat-prussian.css', 'atom-one-dark', true, '#1d4e89' ),
			'phycat-sakura'   => $this->theme( 'phycat-sakura', __( '樱花猫', 'easymde' ), 'assets/themes/article/phycat-sakura.css', 'atom-one-dark', true, '#ff7096' ),
			'phycat-mauve'    => $this->theme( 'phycat-mauve', __( '淡紫猫', 'easymde' ), 'assets/themes/article/phycat-mauve.css', 'atom-one-dark', true, '#a06eb4' ),
			'mdmdt'           => $this->theme( 'mdmdt', __( 'Mdmdt 浅色', 'easymde' ), 'assets/themes/article/mdmdt.css', 'atom-one-dark', true, '#3e69d7' ),
			'dogschoice-pink' => $this->theme( 'dogschoice-pink', __( '狗狗粉', 'easymde' ), 'assets/themes/article/dogschoice-pink.css', 'atom-one-dark', true, '#f55066' ),
			'bloom-petal'     => $this->theme( 'bloom-petal', __( '花瓣', 'easymde' ), 'assets/themes/article/bloom-petal.css', 'atom-one-dark', true, '#e63f9f' ),
			'bloom-mist'      => $this->theme( 'bloom-mist', __( '雾蓝', 'easymde' ), 'assets/themes/article/bloom-mist.css', 'atom-one-dark', true, '#34698c' ),
			'bloom-verdant'   => $this->theme( 'bloom-verdant', __( '草木', 'easymde' ), 'assets/themes/article/bloom-verdant.css', 'atom-one-dark', true, '#3d7055' ),
			'bloom-stone'     => $this->theme( 'bloom-stone', __( '暖石', 'easymde' ), 'assets/themes/article/bloom-stone.css', 'atom-one-dark', true, '#82564f' ),
			'bloom-wheat'     => $this->theme( 'bloom-wheat', __( '麦穗', 'easymde' ), 'assets/themes/article/bloom-wheat.css', 'atom-one-dark', true, '#947d53' ),
			'bloom-ink'       => $this->theme( 'bloom-ink', __( '水墨', 'easymde' ), 'assets/themes/article/bloom-ink.css', 'atom-one-dark', true, '#a74639' ),
			'bloom-amber'     => $this->theme( 'bloom-amber', __( '琥珀', 'easymde' ), 'assets/themes/article/bloom-amber.css', 'atom-one-dark', true, '#b77b29' ),
			'bloom-lapis'     => $this->theme( 'bloom-lapis', __( '青金', 'easymde' ), 'assets/themes/article/bloom-lapis.css', 'atom-one-dark', true, '#2f62ac' ),
			'bloom-ripple'    => $this->theme( 'bloom-ripple', __( '涟漪', 'easymde' ), 'assets/themes/article/bloom-ripple.css', 'atom-one-dark', true, '#009c9c' ),
			'bloom-cinnabar'  => $this->theme( 'bloom-cinnabar', __( '丹红', 'easymde' ), 'assets/themes/article/bloom-cinnabar.css', 'atom-one-dark', true, '#c53637' ),
			'bloom-sage'      => $this->theme( 'bloom-sage', __( '鼠尾草', 'easymde' ), 'assets/themes/article/bloom-sage.css', 'atom-one-dark', true, '#848e38' ),
			'bloom-spring'    => $this->theme( 'bloom-spring', __( '紫语', 'easymde' ), 'assets/themes/article/bloom-spring.css', 'atom-one-dark', true, '#877deb' ),
			'spring'          => $this->theme( 'spring', __( '春日', 'easymde' ), 'assets/themes/article/spring.css', 'atom-one-dark', true, '#3ea173' ),
