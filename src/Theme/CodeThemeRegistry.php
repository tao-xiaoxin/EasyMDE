...
final class CodeThemeRegistry {
	...
	public function all() {
		$themes = array(
			...
			'phycat-cherry-code'   => $this->theme( 'phycat-cherry-code', __( '樱桃猫代码', 'easymde' ), 'assets/themes/code/typora-derived.css', 'owned' ),
			'phycat-caramel-code'  => $this->theme( 'phycat-caramel-code', __( '焦糖猫代码', 'easymde' ), 'assets/themes/code/typora-derived.css', 'owned' ),
			'phycat-forest-code'   => $this->theme( 'phycat-forest-code', __( '森林猫代码', 'easymde' ), 'assets/themes/code/typora-derived.css', 'owned' ),
			'phycat-mint-code'     => $this->theme( 'phycat-mint-code', __( '薄荷猫代码', 'easymde' ), 'assets/themes/code/typora-derived.css', 'owned' ),
			'phycat-sky-code'      => $this->theme( 'phycat-sky-code', __( '天蓝猫代码', 'easymde' ), 'assets/themes/code/typora-derived.css', 'owned' ),
			'phycat-prussian-code' => $this->theme( 'phycat-prussian-code', __( '普鲁士猫代码', 'easymde' ), 'assets/themes/code/typora-derived.css', 'owned' ),
			'phycat-sakura-code'   => $this->theme( 'phycat-sakura-code', __( '樱花猫代码', 'easymde' ), 'assets/themes/code/typora-derived.css', 'owned' ),
			'phycat-mauve-code'    => $this->theme( 'phycat-mauve-code', __( '淡紫猫代码', 'easymde' ), 'assets/themes/code/typora-derived.css', 'owned' ),
