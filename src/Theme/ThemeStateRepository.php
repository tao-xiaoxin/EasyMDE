    ...
    private function get_font_options()
    {
        return array(
            'customFonts' => array(
                ...
                array('id' => 'optima', 'label' => 'Optima', 'fontFamily' => '"Optima-Regular", "Optima"'),
                array('id' => 'orange-heart-inter', 'label' => 'Inter (orange-heart)', 'fontFamily' => 'Inter'),
                array('id' => 'red-crimson-inter', 'label' => 'Inter (red-crimson)', 'fontFamily' => 'Inter'),
                array('id' => 'rose-purple-optima', 'label' => 'Optima (rose-purple)', 'fontFamily' => 'Optima'),
                array('id' => 'ningye-purple-inter', 'label' => 'Inter (ningye-purple)', 'fontFamily' => 'Inter'),
                array('id' => 'cupid-busy-inter', 'label' => 'Inter (cupid-busy)', 'fontFamily' => 'Inter'),
                array('id' => 'tech-blue-optima', 'label' => 'Optima (科技蓝)', 'fontFamily' => 'Optima'),
                array('id' => 'georgia', 'label' => 'Georgia', 'fontFamily' => '"Georgia"'),
                array('id' => 'times', 'label' => 'Times', 'fontFamily' => '"Times", "Times New Roman"'),
                array('id' => 'cochin', 'label' => 'Cochin', 'fontFamily' => '"Cochin"'),
                array('id' => 'helvetica-neue', 'label' => 'Helvetica Neue', 'fontFamily' => '"Helvetica Neue"'),
            ),
            'windowsFonts' => array(
                array('id' => 'microsoft-yahei', 'label' => __('Microsoft YaHei', 'easymde'), 'fontFamily' => '"Microsoft YaHei", "微软雅黑"'),
                array('id' => 'orange-heart-microsoft-yahei', 'label' => 'Microsoft YaHei (orange-heart)', 'fontFamily' => '"Microsoft YaHei"'),
                array('id' => 'red-crimson-microsoft-yahei', 'label' => 'Microsoft YaHei (red-crimson)', 'fontFamily' => '"Microsoft YaHei"'),
                array('id' => 'rose-purple-microsoft-yahei', 'label' => 'Microsoft YaHei (rose-purple)', 'fontFamily' => '"Microsoft YaHei"'),
                array('id' => 'ningye-purple-microsoft-yahei', 'label' => 'Microsoft YaHei (ningye-purple)', 'fontFamily' => '"Microsoft YaHei"'),
                array('id' => 'cupid-busy-microsoft-yahei', 'label' => 'Microsoft YaHei (cupid-busy)', 'fontFamily' => '"Microsoft YaHei"'),
                array('id' => 'tech-blue-microsoft-yahei', 'label' => 'Microsoft YaHei (科技蓝)', 'fontFamily' => '"Microsoft YaHei"'),
            ),
            'appleFonts' => array(
                array('id' => 'pingfang-sc-light', 'label' => __('PingFang SC Light', 'easymde'), 'fontFamily' => '"PingFangSC-light", "PingFangSC-Light"'),
                array('id' => 'pingfang-sc-regular-raw', 'label' => 'PingFangSC-regular', 'fontFamily' => 'PingFangSC-regular'),
            ...
            'serifOptions' => array(
                array('id' => 'yes', 'label' => __('Yes', 'easymde'), 'fontFamily' => '"Optima-Regular", "Optima", "PingFangSC-light", "PingFangTC-light", "PingFang SC", "Cambria", "Cochin", "Georgia", "Times", "Times New Roman", serif'),
                array('id' => 'serif-only', 'label' => 'serif', 'fontFamily' => 'serif'),
                array('id' => 'sans-serif-only', 'label' => 'sans-serif', 'fontFamily' => 'sans-serif'),
                array('id' => 'no', 'label' => __('No', 'easymde'), 'fontFamily' => '"Roboto", "Oxygen", "Ubuntu", "Cantarell", "PingFangSC-light", "PingFangTC-light", "Open Sans", "Helvetica Neue", sans-serif'),
            ),
        );
    }
