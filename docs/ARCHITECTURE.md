...
- `frontend/`: strict TypeScript, React, CodeMirror, and Vite source for the production normal-editor Toolbar, document session, Preview Surface, Font controls, and Appearance controls, plus the test-only WordPress React build-contract fixture.
