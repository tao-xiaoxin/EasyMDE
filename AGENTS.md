...
- Immersive writing mode is a temporary client-side editor state. It expands EasyMDE over the WordPress edit screen for the current page view only; do not persist it in post meta, user meta, options, or localStorage.
