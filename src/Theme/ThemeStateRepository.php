...
final class ThemeStateRepository
{
    ...
    private function get_font_options()
    {
        return array(
            'customFonts' => array(
                array('id' => 'none', 'label' => __('No custom font', 'easymde'), 'fontFamily' => ''),
                array('id' => 'optima', 'label' => __('Optima', 'easymde'), 'fontFamily' => '"Optima-Regular", "Optima"'),
                array('id' => 'orange-heart-inter', 'label' => __('Inter (orange-heart)', 'easymde'), 'fontFamily' => 'Inter'),
                array('id' => 'red-crimson-inter', 'label' => __('Inter (red-crimson)', 'easymde'), 'fontFamily' => 'Inter'),
                array('id' => 'rose-purple-optima', 'label' => __('Optima (rose-purple)', 'easymde'), 'fontFamily' => 'Optima'),
                array('id' => 'ningye-purple-inter', 'label' => __('Inter (ningye-purple)', 'easymde'), 'fontFamily' => 'Inter'),
                array('id' => 'cupid-busy-inter', 'label' => __('Inter (cupid-busy)', 'easymde'), 'fontFamily' => 'Inter'),
                array('id' => 'tech-blue-optima', 'label' => __('Optima (tech-blue)', 'easymde'), 'fontFamily' => 'Optima'),
                array('id' => 'georgia', 'label' => __('Georgia', 'easymde'), 'fontFamily' => '"Georgia"'),
                array('id' => 'times', 'label' => __('Times', 'easymde'), 'fontFamily' => '"Times", "Times New Roman"'),
                array('id' => 'cochin', 'label' => __('Cochin', 'easymde'), 'fontFamily' => '"Cochin"'),
                array('id' => 'helvetica-neue', 'label' => __('Helvetica Neue', 'easymde'), 'fontFamily' => '"Helvetica Neue"'),
            ),
            'windowsFonts' => array(
                array('id' => 'microsoft-yahei', 'label' => __('Microsoft YaHei', 'easymde'), 'fontFamily' => '"Microsoft YaHei", "微软雅黑"'),
                array('id' => 'orange-heart-microsoft-yahei', 'label' => __('Microsoft YaHei (orange-heart)', 'easymde'), 'fontFamily' => '"Microsoft YaHei"'),
                array('id' => 'red-crimson-microsoft-yahei', 'label' => __('Microsoft YaHei (red-crimson)', 'easymde'), 'fontFamily' => '"Microsoft YaHei"'),
                array('id' => 'rose-purple-microsoft-yahei', 'label' => __('Microsoft YaHei (rose-purple)', 'easymde'), 'fontFamily' => '"Microsoft YaHei"'),
                array('id' => 'ningye-purple-microsoft-yahei', 'label' => __('Microsoft YaHei (ningye-purple)', 'easymde'), 'fontFamily' => '"Microsoft YaHei"'),
                array('id' => 'cupid-busy-microsoft-yahei', 'label' => __('Microsoft YaHei (cupid-busy)', 'easymde'), 'fontFamily' => '"Microsoft YaHei"'),
                array('id' => 'tech-blue-microsoft-yahei', 'label' => __('Microsoft YaHei (tech-blue)', 'easymde'), 'fontFamily' => '"Microsoft YaHei"'),
            ),
            'appleFonts' => array(
                array('id' => 'pingfang-sc-light', 'label' => __('PingFang SC Light', 'easymde'), 'fontFamily' => '"PingFangSC-light", "PingFangSC-Light"'),
                array('id' => 'pingfang-sc-regular-raw', 'label' => __('PingFangSC-regular', 'easymde'), 'fontFamily' => 'PingFangSC-regular'),
                array('id' => 'pingfang-sc-regular', 'label' => __('PingFang SC Regular', 'easymde'), 'fontFamily' => '"PingFang SC"'),
                array('id' => 'pingfang-tc-light', 'label' => __('PingFang TC Light', 'easymde'), 'fontFamily' => '"PingFangTC-light", "PingFangTC-Light"'),
                array('id' => 'pingfang-tc-regular', 'label' => __('PingFang TC Regular', 'easymde'), 'fontFamily' => '"PingFang TC"'),
            ),
            'serifOptions' => array(
                array('id' => 'yes', 'label' => _x('Yes', 'serif font fallback option', 'easymde'), 'fontFamily' => '"Optima-Regular", "Optima", "PingFangSC-light", "PingFangTC-light", "PingFang SC", "Cambria", "Cochin", "Georgia", "Times", "Times New Roman", serif'),
                array('id' => 'serif-only', 'label' => __('serif', 'easymde'), 'fontFamily' => 'serif'),
                array('id' => 'sans-serif-only', 'label' => __('sans-serif', 'easymde'), 'fontFamily' => 'sans-serif'),
                array('id' => 'no', 'label' => _x('No', 'serif font fallback option', 'easymde'), 'fontFamily' => '"Roboto", "Oxygen", "Ubuntu", "Cantarell", "PingFangSC-light", "PingFangTC-light", "Open Sans", "Helvetica Neue", sans-serif'),
            ),
        );
    }
