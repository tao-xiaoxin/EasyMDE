...
| Commit, push, PR linkage, and bot review request | Completed | PR #165 remains open under human maintainer control; production behavior last changed at `4bad582`, and branch-tip CI and CodeRabbit evidence remains visible in the PR history |
