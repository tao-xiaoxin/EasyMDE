...
final class AdminAssets {
	...
	private function get_storage_config( $post_id ) {
		...
		return array(
			...
			'layoutKey' => 'easymde:layout:' . $site_key . ':' . $user_id,
		);
	}
	...
	private function get_strings() {
		return array(
			...
			'workspaceDivider'                      => __( 'Resize editor panes', 'easymde' ),
			'documentOutline'                       => __( 'Document outline', 'easymde' ),
			'outlineEmpty'                          => __( 'Add headings to build an outline.', 'easymde' ),
			...
			'wordStats'                             => __( 'Word statistics', 'easymde' ),
			'readingTime'                           => __( 'Reading time', 'easymde' ),
			'readingTimeUnit'                       => __( 'min', 'easymde' ),
			'readingTimeHelp'                       => __( 'Reading time uses 200 western words per minute plus 300 CJK characters per minute, rounded up.', 'easymde' ),
			'lineCount'                             => __( 'Lines', 'easymde' ),
			'statusEditing'                         => __( 'Editing', 'easymde' ),
			'statusReady'                           => __( 'Saved', 'easymde' ),
			'versionHistory'                        => __( 'Version history', 'easymde' ),
			'westernWordCount'                      => __( 'Western words', 'easymde' ),
			'cjkCharacterCount'                     => __( 'CJK characters', 'easymde' ),
			'totalCharacterCount'                   => __( 'Total characters', 'easymde' ),
			'publishPost'                           => __( 'Publish', 'easymde' ),
			'updatePost'                            => __( 'Update', 'easymde' ),
			'publishPostTitle'                      => __( 'Publish article', 'easymde' ),
			'updatePostTitle'                       => __( 'Update article', 'easymde' ),
			'publishPanelReadOnlyHelp'              => __( 'Opening this panel only reads the current WordPress post state. Nothing is written until you confirm the native submit action.', 'easymde' ),
			'publishPanelTags'                      => __( 'Tags', 'easymde' ),
			'publishPanelExcerpt'                   => __( 'Excerpt', 'easymde' ),
			'publishPanelCategories'                => __( 'Categories', 'easymde' ),
			'publishPanelFeaturedImage'             => __( 'Featured image', 'easymde' ),
			'publishPanelKeepCurrent'               => __( 'Keep current selection', 'easymde' ),
			'publishPanelClearFeaturedImage'        => __( 'Clear featured image', 'easymde' ),
			'publishPanelClearFeaturedImagePending' => __( 'Will clear featured image', 'easymde' ),
			'publishPanelChooseFeaturedImage'       => __( 'Choose featured image', 'easymde' ),
			'publishPanelEmpty'                     => __( 'Not set', 'easymde' ),
			'publishPanelPreviewAfter'              => __( 'Preview after publish', 'easymde' ),
			'publishPanelUseFirstImage'             => __( 'Use first local image', 'easymde' ),
			'publishPreviewBlocked'                 => __( 'The browser blocked the preview window. The post was saved successfully.', 'easymde' ),
			'publishPreviewMissing'                 => __( 'The post was saved, but no native preview link was available to open automatically.', 'easymde' ),
