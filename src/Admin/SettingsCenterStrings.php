...
final class SettingsCenterStrings {
	...
	public static function get() {
		return array(
			...
			'r2ApiEndpoint'                                => __( 'R2 API Endpoint', 'easymde' ),
			'providerRegion'                               => __( 'Region', 'easymde' ),
			'bucket'                                       => __( 'Storage Space / Bucket', 'easymde' ),
			'customDomain'                                 => __( 'Custom Domain', 'easymde' ),
			'imageFallbackDomain'                          => __( 'Image Fallback Domain', 'easymde' ),
			'imageFallbackDomainDescription'               => __( 'Use the same object path to generate an alternate read URL. This does not automatically replace the primary URL returned after upload.', 'easymde' ),
			...
			'credentialsConfiguredHint'                    => __( 'Credentials are configured and remain stored securely in WordPress.', 'easymde' ),
			'replaceCredentialsHint'                       => __( 'Leave blank to keep the saved credentials, or enter new values to replace them.', 'easymde' ),
			'connectionStatus'                             => __( 'Connection Status', 'easymde' ),
			'backupConnectionStatus'                       => __( 'Backup Connection Status', 'easymde' ),
			'connectionPending'                            => __( 'Not Tested', 'easymde' ),
			'testingConnection'                            => __( 'Testing Connection…', 'easymde' ),
			'connected'                                    => __( 'Connected', 'easymde' ),
			'connectionFailed'                             => __( 'Connection Failed', 'easymde' ),
			'connectionStale'                              => __( 'Settings Changed; Test Again', 'easymde' ),
			/* translators: %s: localized date and time of the most recent connection test. */
			'lastTested'                                   => __( 'Last tested: %s', 'easymde' ),
			'testPrimaryConnection'                        => __( 'Test Connection', 'easymde' ),
			'testBackupConnection'                         => __( 'Test Backup Connection', 'easymde' ),
			'imageHostFailureConfiguration'                => __( 'Complete the required image host settings before testing.', 'easymde' ),
			...
			'duplicateImageHostDescription'                => __( 'Change the backup service, bucket, endpoint, or region so it does not duplicate the primary upload target.', 'easymde' ),
