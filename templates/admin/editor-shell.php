...
?>
<div id="easymde-editor" class="easymde-editor" data-post-id="<?php echo esc_attr( $easymde_editor_post->ID ); ?>" data-easymde-markdown-fingerprint="<?php echo esc_attr( $easymde_markdown_fingerprint ); ?>" data-easymde-preview-request-owner="legacy" data-easymde-preview-surface-owner="legacy">
	...
	<div class="easymde-workspace">
		...
		<section class="easymde-pane easymde-pane-preview">
			...
			<div id="easymde-preview-session-react" class="easymde-preview-react-root" hidden></div>
		</section>
