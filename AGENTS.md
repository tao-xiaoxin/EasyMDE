...
| --- | --- |
| `README.md`, `README.en.md` | GitHub product and installation entry points. |
...
| `docs/USER_GUIDE.md` | User-observable editor behavior and workflows. |
| `docs/DEVELOPMENT.md` | Local development environment and setup. |
| `docs/PLUGIN_CHECK.md` | Accepted Plugin Check warnings and rationale. |
| `docs/decisions/` | Durable architectural decision records. |
