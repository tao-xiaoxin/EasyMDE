...
| Lucide icon paths | 0.487.0 | https://github.com/lucide-icons/lucide/tree/0.487.0 | ISC | Locally embedded SVG path data for the isolated immersive workspace controls. | Yes, copied to assets/js/admin/immersive-workspace.js | assets/vendor/lucide/LICENSE |
