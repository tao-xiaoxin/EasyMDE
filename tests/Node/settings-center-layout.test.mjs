...
test("Settings Center header title resets WordPress admin padding", () => {
	...
	assert.match(
		cssRuleBody(".easymde-settings-center__header-scale header > div"),
		/\btop:\s*93\.6px;/,
	);
	assert.match(
		cssRuleBody(".easymde-settings-center__header-scale header > div"),
	...
	assert.match(
		cssRuleBody(".easymde-settings-center__header-scale header p"),
		/\bmargin-top:\s*7\.2px;/,
	);
	assert.match(
		cssRuleBody(".easymde-settings-center__header-scale header p"),
	...
	assert.match(
		cssRuleBody(".easymde-settings-center__header-scale header p"),
		/\bline-height:\s*21\.6px;/,
	);
	assert.match(
		cssRuleBody(".easymde-settings-center__header-scale header > a"),
		/\btop:\s*16\.2px;/,
	);
	assert.match(
		cssRuleBody(".easymde-settings-center__header-scale header > a"),
	...
	assert.match(
		cssRuleBody(".easymde-settings-center__header-scale header > a"),
		/\bborder-radius:\s*5\.625px;/,
	);
	assert.match(
		cssRuleBody(".easymde-settings-center__header-scale header > a svg"),
		/\bwidth:\s*20\.7px;/,
	);
	assert.match(
		cssRuleBody(".easymde-settings-center__header-scale header > a svg"),
