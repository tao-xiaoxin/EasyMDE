...
final class AdminAssets {
		...
		return array(
			...
			'immersive'          => array(
				'strings' => array(
					...
					'characters'   => $strings['immersiveCharacters'],
					'columns'      => $strings['immersiveColumns'],
					'content'      => $strings['immersiveTableContent'],
					'enter'        => $strings['enterImmersiveWriting'],
					'escapeExit'   => $strings['immersiveEscapeExit'],
					'exit'         => $strings['exitImmersiveWriting'],
					'exitHint'     => $strings['exitImmersiveWritingHint'],
					'insertTable'  => $strings['insertTable'],
					'minutes'      => $strings['immersiveMinutes'],
					'rows'         => $strings['immersiveRows'],
					'startWriting' => $strings['startWriting'],
					'table'        => $strings['table'],
					'tableSize'    => $strings['immersiveTableSize'],
					'untitled'     => $strings['untitled'],
					'words'        => $strings['immersiveWords'],
				),
			),
			'layout'             => array(
	...
	private function get_strings() {
		return array(
			...
			'enterImmersiveWriting'     => __( 'Enter immersive writing', 'easymde' ),
			'exitImmersiveWriting'      => __( 'Exit', 'easymde' ),
			'exitImmersiveWritingHint'  => __( 'Exit immersive writing (Esc)', 'easymde' ),
			'immersiveEscapeExit'       => __( 'Esc to exit', 'easymde' ),
			'immersiveWords'            => __( 'words', 'easymde' ),
			'immersiveCharacters'       => __( 'characters', 'easymde' ),
			/* translators: %s is the estimated reading time in minutes. */
			'immersiveMinutes'          => __( 'About %s minutes', 'easymde' ),
			'untitled'                  => __( 'Untitled', 'easymde' ),
			'startWriting'              => __( 'Start writing…', 'easymde' ),
			'table'                     => __( 'Table', 'easymde' ),
			'insertTable'               => __( 'Insert table', 'easymde' ),
			'immersiveRows'             => __( 'Rows', 'easymde' ),
			'immersiveColumns'          => __( 'Columns', 'easymde' ),
			'immersiveTableContent'     => __( 'Content', 'easymde' ),
			/* translators: 1: number of rows, 2: number of columns. */
			'immersiveTableSize'        => __( '%1$s rows × %2$s columns', 'easymde' ),
